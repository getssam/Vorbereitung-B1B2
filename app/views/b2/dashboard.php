        ...
        <div class="section-card sub-content active" id="lesen-b2-part1">
            ...
            <div class="quiz-grid">
                <?php foreach ($quizzes['lesen']['part1'] as $quiz): ?>
                    <a class="quiz-btn" href="<?php echo url('quiz/' . $quiz['file'] . '?level=B2'); ?>"><?php echo $quiz['name']; ?></a>
                <?php endforeach; ?>
            </div>
        </div>
    ...
    <div id="tab-b2-schreiben" class="tab-content">
        <div class="section-card">
            ...
            <div style="display: grid; gap: 16px;">
                ...
                <textarea id="write1B2" style="width: 100%; min-height: 220px; border-radius: 12px; padding: 14px; font-size: 1rem;"></textarea>
                <div style="display:flex; align-items:center; justify-content:space-between;">
                    <div id="write1CountB2" style="font-weight:700; color: var(--text-light);">0 Wörter</div>
                    <div style="display:flex; gap:8px;">
                        <button id="write1B2Save" class="btn btn-secondary" style="padding:8px 16px;">Speichern</button>
                        <button id="write1B2Copy" class="btn" style="padding:8px 16px;">Kopieren</button>
                        <button id="write1B2Clear" class="btn btn-danger" style="padding:8px 16px;">Leeren</button>
                    </div>
                </div>
            </div>
        </div>
        <div class="section-card">
            ...
            <div style="display: grid; gap: 16px;">
                ...
                <textarea id="write2B2" style="width: 100%; min-height: 220px; border-radius: 12px; padding: 14px; font-size: 1rem;"></textarea>
                <div style="display:flex; align-items:center; justify-content:space-between;">
                    <div id="write2CountB2" style="font-weight:700; color: var(--text-light);">0 Wörter</div>
                    <div style="display:flex; gap:8px;">
                        <button id="write2B2Save" class="btn btn-secondary" style="padding:8px 16px;">Speichern</button>
                        <button id="write2B2Copy" class="btn" style="padding:8px 16px;">Kopieren</button>
                        <button id="write2B2Clear" class="btn btn-danger" style="padding:8px 16px;">Leeren</button>
                    </div>
                </div>
            </div>
        </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    updateCount('write1B2', 'write1CountB2', 'b2_write1');
    updateCount('write2B2', 'write2CountB2', 'b2_write2');
});
</script>
